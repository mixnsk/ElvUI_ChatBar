...
qChatBarMover:CreatePanel("Default",150,36,"CENTER", UIParent, "CENTER", -273, -75)
qChatBarMover:Hide()
E.CreateMover(qChatBarMover, "qChatBarMoverMover", "Move ChatBat")
...
function addon:Style()
	...
	s:SetPoint("RIGHT", qChatBarMover, "TOPLEFT", 0, 0)
	s:SetWidth(width)
	s:SetHeight(height)
	framechat(s)
	CreateShadow(s)
	...
	w:SetPoint("RIGHT", s, "RIGHT", 0, -12.2)
	w:SetWidth(width)
	w:SetHeight(height)
	framechat(w)
	CreateShadow(w)
	...
	g:SetPoint("RIGHT", w, "RIGHT", 0, -12.2)
	g:SetWidth(width)
	g:SetHeight(height)
	framechat(g)
	CreateShadow(g)
	...
	o:SetPoint("RIGHT", g, "RIGHT", 0, -12.2)
	o:SetWidth(width)
	o:SetHeight(height)
	framechat(o)
	CreateShadow(o)
	...
	r:SetPoint("RIGHT", o, "RIGHT", 0, -12.2)
	r:SetWidth(width)
	r:SetHeight(height)
	framechat(r)
	CreateShadow(r)
	...
	p:SetPoint("RIGHT", r, "RIGHT", 0, -12.2)
	p:SetWidth(width)
	p:SetHeight(height)
	framechat(p)
	CreateShadow(p)
	...
	ge:SetPoint("RIGHT", p, "RIGHT", 0, -12.2)
	ge:SetWidth(width)
	ge:SetHeight(height)
	framechat(ge)
	CreateShadow(ge)
	...
	t:SetPoint("RIGHT", ge, "RIGHT", 0, -12.2)
	t:SetWidth(width)
	t:SetHeight(height)
	framechat(t)
	CreateShadow(t)
	...
	d:SetPoint("RIGHT", t, "RIGHT", 0, -12.2)
	d:SetWidth(width)
	d:SetHeight(height)
	framechat(d)
	CreateShadow(d)
	...
	y:SetPoint("RIGHT", d, "RIGHT", 0, -12.2)
	y:SetWidth(width)
	y:SetHeight(height)
	framechat(y)
	CreateShadow(y)
